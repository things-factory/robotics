...
function infrared1DataCallback(data) {
  ...
  fileReader.onload = function (event) {
    ...
    drawInfraredToCanvas(0, arrayBuffer, {
      width: glData.textureWidth[0],
      height: glData.textureHeight[0]
    })
  }
...
function infrared2DataCallback(data) {
  ...
  fileReader.onload = function (event) {
    ...
    drawInfraredToCanvas(1, arrayBuffer, {
      width: glData.textureWidth[1],
      height: glData.textureHeight[1]
    })
  }
  fileReader.readAsArrayBuffer(data)
}
...
function drawScene(index, viewPortSize) {
...

  {
    ...
    gl.enableVertexAttribArray(glData.shader[index].attributeLocations.vertexPosition)
  }

  {
    ...
    gl.vertexAttribPointer(glData.shader[index].attributeLocations.textureCoord, num, type, normalize, stride, offset)
